## Author: Carey W. King, March-May, 2019. Unviersity of Texas at Austin, Energy Institute.
##
...
solveGEN <- function(RegionNumber,year, coal_percent, PV_percent, CSP_percent, wind_percent, nuclear_percent, hydro_percent, biomass_percent, geothermal_percent, petroleum_percent){
  ...
  CSP_percent = CSP_percent / 100
  wind_percent = wind_percent / 100
  biomass_percent = biomass_percent / 100
  hydro_percent = hydro_percent / 100
...
Frac_MWhDesired_dispatchable$Fraction_MWhDesired[which(Frac_MWhDesired_dispatchable$Technology==c("Geothermal"))] <- geothermal_percent  ## Geothermal
...
Frac_MWhDesired_Nondispatchable$Fraction_MWhDesired[which(Frac_MWhDesired_Nondispatchable$Technology==c("Nuclear"))] <- nuclear_percent ## Nuclear
Frac_MWhDesired_Nondispatchable$Fraction_MWhDesired[which(Frac_MWhDesired_Nondispatchable$Technology==c("PV"))] <- PV_percent      ## Solar PV
Frac_MWhDesired_Nondispatchable$Fraction_MWhDesired[which(Frac_MWhDesired_Nondispatchable$Technology==c("Wind"))] <- wind_percent    ## Wind
Frac_MWhDesired_Nondispatchable$Fraction_MWhDesired[which(Frac_MWhDesired_Nondispatchable$Technology==c("CSP"))] <- CSP_percent    ## Solar CSP
Frac_MWhDesired_Nondispatchable$Fraction_MWhDesired[which(Frac_MWhDesired_Nondispatchable$Technology==c("HydroNonDispatch"))] <- hydro_percent    ## Nondispatchable portio of hydropower
...
## ++++++++++++
## END
## FUNCTION function_Wind_PV_CSP_daily_storage_tiny
## ++++++++++++
...
## ++++++++++++
## BEGIN
## FUNCTION function_solve_hydro_dispatch
## ++++++++++++## ++++++++++++++++
...
## +++++++++++++++++
## total cost in $/MWh for the mix of generators chosen by the user in the final year for which the user has chosen the mix
