...
generate8760 <- function(RegionNumber,year,percent_ResidentialHeatPump,percent_ResidentialNG,percent_ElectricLDV,LDVmiles_per_region_2050){
...
load("generate8760_data/SingleEVChargeProfiles_MWh_8760_Input_to_solveGEN_NOT_REAL_YET.RData")
...
LDV_miles_per_kwh_2050 = 4.0 ## assumed miles per kWh average for light duty vehicles miles driven on electricity in 2050. Assume this includes discharge and charge efficiency in battery, so this number represents total kWh into the car.
## LDVmiles_per_region_2050 -- This is now an input to this function
